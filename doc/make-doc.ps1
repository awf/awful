...
echo "<!-- AUTOGENERATED FROM $src -->" | out-file -enc utf8 $dst
$contents_html = cat Contents.html
cat $src | % { 
...
echo "<!-- AUTOGENERATED FROM Documentation.html -->" | out-file -enc utf8 Home.html
$contents_html = cat Contents.html
cat Documentation.html | % { 
  $_ -replace '<!TOC>',
} | out-file -append -enc utf8 Home.html
